...
export default function Dashboard(params) {
    ...
    function goPromo() {
        window.location = params.globalVars.myUrl + "promo"
        setProgressBar(true)
    }
                            ...
                            <div style={{ marginBottom: '1em' }} className="col-lg-4 col-md-4 col-sm-6 col-6"  >
                                <div onClick={goProducts} className="card border border-primary card-flyer pointer">
                                    ...
                                    <div style={{ textAlign: 'center' }} className="card-body">
                                        <h2 style={{ color: params.globalVars.info == null ? 'black' : params.globalVars.info.color_letra_navbar }} className="card-title superTitulo">Productos</h2>
                                    </div>
                                </div>
                            </div>
                            <div style={{ marginBottom: '1em', display: 'none' }} className="col-lg-4 col-md-4 col-sm-6 col-6"  >
                                <div onClick={goPromo} className="card border border-primary card-flyer pointer">
                                    <img style={{ width: '15em', height: '10em', marginTop: '1em' }} src={logoCarousel} className="card-img-top img-fluid centerImg" alt="" />
                                    <div style={{ textAlign: 'center' }} className="card-body">
                                        <h2 style={{ color: params.globalVars.info == null ? 'black' : params.globalVars.info.color_letra_navbar }} className="card-title superTitulo">Carrusel</h2>
                                    </div>
                                </div>
                            </div>
                            <div style={{ marginBottom: '1em' }} className="col-lg-4 col-md-4 col-sm-6 col-6"  >
                                <div onClick={goVentas} className="card border border-primary card-flyer pointer">
                                    ...
                                    <div style={{ textAlign: 'center' }} className="card-body">
                                        <h2 style={{ color: params.globalVars.info == null ? 'black' : params.globalVars.info.color_letra_navbar }} className="card-title superTitulo">Ventas</h2>
                                    </div>
                                </div>
                            </div>
                            <div style={{ marginBottom: '1em' }} className="col-lg-4 col-md-4 col-sm-6 col-6"  >
