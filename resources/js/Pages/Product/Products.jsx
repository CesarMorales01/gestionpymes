                    ...
                    <div className="col-12">
                        <form>
                            <div className="flex items-center py-3">
                                <input style={{ marginLeft: '0.8em' }} size={window.innerWidth < 600 ? '31' : '40'} id='inputBuscar' onClick={buscarInAllProducts} onChange={cambioNombre} className="rounded" type="text" placeholder="Buscar producto..." aria-label="Full name" />
