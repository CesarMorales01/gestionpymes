                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                            <form>
                                <div className="flex items-center py-3">
                                    <input  size={window.innerWidth < 600 ? '27' : '40'} id='inputBuscar' onClick={validarAllShopping} className="rounded py-2" type="text" placeholder="Buscar venta..." aria-label="Full name" />
